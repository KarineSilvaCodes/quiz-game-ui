...
public class CavaleirosZodiacoUI extends JFrame {
    ...
    public CavaleirosZodiacoUI() {
        try { UIManager.setLookAndFeel("javax.swing.plaf.nimbus.NimbusLookAndFeel"); } catch (Exception ignored) {}

        setTitle("⚔️ Quiz de Cavaleiros do Zodíaco");
        setSize(760, 520);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(new BorderLayout());
        getContentPane().setBackground(new Color(255, 235, 200)); // fundo bege

        // Painel da pergunta
        JPanel painelPergunta = new JPanel(new BorderLayout());
        painelPergunta.setBackground(new Color(255, 170, 85)); // laranja
    ...
    private void carregarPerguntas() {
        ...
        // Adicione todas as outras perguntas do Cavaleiros do Zodíaco aqui
        Collections.shuffle(perguntas);
    }

    public static void main(String[] args) {
        SwingUtilities.invokeLater(CavaleirosZodiacoUI::new);
    }
