...
public class HunterxHunterData {
        ...
        public static List<Pergunta> getHunterxHunter() {
                ...
                lista.add(new Pergunta("Quem é o protagonista da série?",
                                ...
                                0,
                                new String[] { "Correto! Gon é o protagonista!", "Killua é amigo e rival!",
                                                "Kurapika é aliado!", "Leorio é amigo!" }));

                lista.add(new Pergunta("Quem é da famosa família assassina Zoldyck?",
                                new String[] { "Killua", "Gon", "Kurapika", "Leorio" },
                                0,
                                new String[] { "Correto! Killua é da família Zoldyck!", "Gon não é assassino!",
                                                "Kurapika não!", "Leorio não!" }));

                lista.add(new Pergunta("Qual personagem possui correntes para lutar?",
                                new String[] { "Kurapika", "Gon", "Killua", "Leorio" },
                                0,
                                new String[] { "Correto! Kurapika usa correntes!", "Gon usa força física!",
                                                "Killua usa eletricidade!", "Leorio usa socos!" }));

                lista.add(new Pergunta("Quem tem habilidades de eletricidade?",
                                new String[] { "Killua", "Gon", "Kurapika", "Leorio" },
                                0,
                                new String[] { "Correto! Killua domina eletricidade!", "Gon não!", "Kurapika não!",
                                                "Leorio não!" }));
                ...
                lista.add(new Pergunta("Quem participa do Exame Hunter junto com Gon?",
                                ...
                                new String[] { "Correto! Killua participa com Gon!", "Kurapika não participa!",
                                                "Leorio participa!", "Hisoka participa, mas como antagonista!" }));
